...
const DeviceApprovalPage = () => {
   ...
   const userCode = searchParmas.get("user_code")
 ...
 text-center">
         ...
         <div className="relative">
            ...
            <div className="absolute -top-2 -right-2 w-8 h-8 bg-orange-500
  ...
  <div className="space-y-2">
   ...
   <div className="bg-zinc-800 rounded-lg p-4 border-zinc-700">
      <p className="text-xl font-mono font-bold text-cyan-400 text-center tracking-widest">
         {userCode || "---"}
      </p>
   </div>
   <p className="text-xs text-zinc-600 text-center">share this code with requesting device</p>
  </div>
  </div>
{/* Security info card */}
...
<div className="space-y-3">
  ...
  <div className="flex itmes-center gap-3">
   <div className="flex-1 h-px border-dashed border-zinc-700"></div>
